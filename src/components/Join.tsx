...
const channels = [
  {
    id: 'whatsapp',
    platform: 'WhatsApp',
    description: 'Únete al grupo de la comunidad. Actualizaciones, fotos y anuncios de eventos.',
    cta: 'Unirte al grupo',
    href: LINKS.whatsapp,
    external: true,
    icon: (
          ...
          {channels.map((channel, i) => (
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <p className="font-display text-white mb-3" style={{ fontSize: 'clamp(1.5rem, 2vw, 2rem)', fontWeight: 400 }}>
                  {channel.platform}
                </p>
