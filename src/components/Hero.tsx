...
export default function Hero() {
  return (
    <section className="relative min-h-screen flex flex-col justify-end overflow-hidden">
      ...
      {/* Background split — left: SPL_5272, right: SPL_5612 */}
      <div className="absolute inset-0 grid grid-cols-1 md:grid-cols-2">
        <div className="relative overflow-hidden">
          <img src={HERO_IMAGE_2} alt="" className="w-full h-full object-cover object-center scale-105" />
        </div>
        <div className="relative overflow-hidden hidden md:block">
          <img src={HERO_IMAGE} alt="" className="w-full h-full object-cover object-top scale-105" />
        </div>
      </div>
