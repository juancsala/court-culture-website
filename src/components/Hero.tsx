    ...
    <section className="relative min-h-screen flex flex-col justify-end overflow-hidden">
      ...
      <div className="absolute inset-0 grid grid-cols-1 md:grid-cols-2">
        <div className="relative overflow-hidden">
          <img src={HERO_IMAGE} alt="" className="w-full h-full object-cover scale-105" style={{ objectPosition: 'center 20%' }} />
        </div>
        <div className="relative overflow-hidden hidden md:block">
          <img src={HERO_IMAGE_2} alt="" className="w-full h-full object-cover scale-105" style={{ objectPosition: 'center 60%' }} />
        </div>
      </div>
