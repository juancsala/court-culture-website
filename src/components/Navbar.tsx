    ...
    >
      <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
        ...
        <div className="flex items-center gap-5">
          {/* Instagram icon */}
          <a href={LINKS.instagram} target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="hidden md:block text-white/60 hover:text-white transition-colors duration-200">
          ...
          {/* TikTok icon */}
          <a href={LINKS.tiktok} target="_blank" rel="noopener noreferrer" aria-label="TikTok" className="hidden md:block text-white/60 hover:text-white transition-colors duration-200">
